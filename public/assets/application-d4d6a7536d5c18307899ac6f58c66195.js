...
(function ($) {
  ...
  TagsInput.prototype = {
    ...
    add: function(item, dontPushVal) {
      ...
      //EL SIGUIENTE IF PERMITE VALIDAR SI EL TEXTO ES UN EMAIL, SI NO LO ES NO HACE NADA MAS Y TERMINA LA EJEC.*************************************************************************************************************************
      if(!item.toString().match(/\b[A-Z0-9._%+-]+@[A-Z0-9.-]+\.[A-Z]{2,4}\b/i))
        return;
    ...
    Timepicker.prototype = {
        ...
        , init: function () {
            if (this.$element.parent().hasClass('input-group')) {
                this.$element.parent('.input-group').find('.add-on').on('click', $.proxy(this.showWidget, this));
                this.$element.on({
